...
#   recreate.sh N default|yolov6n|fps10|res360
...
case $V in
  ...
  yolov6n) set -- "rtsp://$HOST:8554/mystream_5fps$idx" $ch --fps 5 --decode yolov6 --model models2/yolov6n_surgery_mpk.tar.gz ;;
